...
async function searchMovie() {
    ...
    try {
        ...
        let rate =  Number(data.imdbRating);

        if(rate > 8.5){
            var rec = document.createElement("img");
            rec.src = "https://image.flaticon.com/icons/png/512/411/411724.png";
            rec.setAttribute("id","recImg");

           // only for reccomended movies
            div.append(rec,p,img,p1,p4,p2,p3);
